...
func TestCaseService_CreateCaseAttachment_Succeeds(t *testing.T) {
	...
	svc := NewCaseService(repo, actorUserRepo(t), nil, alwaysUnrestrictedAccess{}, sftpgoClient)
	ctx := attachmentCtx(t)
...
func TestCaseService_CreateCaseAttachment_RequiresFile(t *testing.T) {
	svc := NewCaseService(&stubCaseRepo{}, actorUserRepo(t), nil, alwaysUnrestrictedAccess{}, &fakeSFTPGoClient{})
	ctx := attachmentCtx(t)
...
func TestCaseService_CreateCaseAttachment_RejectsMalformedDataURI(t *testing.T) {
	sftpgoClient := &fakeSFTPGoClient{}
	svc := NewCaseService(&stubCaseRepo{}, actorUserRepo(t), nil, alwaysUnrestrictedAccess{}, sftpgoClient)
	ctx := attachmentCtx(t)
...
func TestCaseService_CreateCaseAttachment_RejectsUnauthenticatedCaller(t *testing.T) {
	svc := NewCaseService(&stubCaseRepo{}, stubUserRepo{}, nil, alwaysUnrestrictedAccess{}, &fakeSFTPGoClient{})
...
func TestCaseService_CreateCaseAttachment_RequiresJWTAssertion(t *testing.T) {
	svc := NewCaseService(caseRepoWithProject(&stubCaseRepo{}), actorUserRepo(t), nil, alwaysUnrestrictedAccess{}, &fakeSFTPGoClient{})
