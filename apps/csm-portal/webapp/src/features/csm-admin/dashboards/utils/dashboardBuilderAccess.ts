 ...
 * allowlist, alongside whatever other roles (possibly none) they already
 * hold — this lets specific non-admin users edit dashboards without
 * granting them the full `admin` role. Matched case-insensitively, same as
 * `ADMIN_ROLE_KEY`.
 */
